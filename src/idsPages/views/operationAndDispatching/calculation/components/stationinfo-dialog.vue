  ...
  props: {
    ...
    paramsList: {//接口所需参数
      ...
      default: {
        planId: "",//预案id
        nodeType:'',//1场站  2客户
        nodeCode:'',//场站code/客户code
        nodeName:'',//场站名/客户名
        simulationType:''//1 24小时仿真 2预案库仿真
    ...
    checkedBtn(newVal,oldVal){
      if(newVal){
        ...
        let params = {
          ...
          gaugingPointType:newVal,//1瞬流 2压力
  ...
  methods: {
    ...
    validateDataBeforeSave(list) {
      for (let i = 0; i < list.length; i++) {
        ...
        //   }
        // }
        for (var k = 1; k < begin.length; k++) {//时间段不可重叠
          if (begin[k] < over[k - 1]) {
            this.isSave = false;
            this.$confirm(
    ...
    submitList(list) {
      ...
      params = {
        list: lists,
        gaugingPointType: this.checkedBtn,
