...
<!--          <el-button round plain type="success" @click="sendPop()" v-if="detail.status === '0'" class="custom-button" icon="el-icon-s-promotion btn-icon" >推送客户</el-button>-->
          ...
          <el-button round plain type="success" @click="printTable()" v-if="detail.status === '2'" class="custom-button" icon="el-icon-printer btn-icon" >打印</el-button>
        </div>
