<template>
  <div class="purchases-deploy gas-page-bg">
    <top-menu
      ...
      title="采购配置"
    ></top-menu>
    <div class="addSet" @click="dialogFormVisibleNew = true">+ 新增</div>
    <div class="purchases-deploy-content">
      <div
        ...
        :key="'a' + index"
      >
        <div class="deploy-content-item-title">
          <div class="title">{{ item.codeTxt }}</div>
          <div class="deploy-content-item-set" @click="setData(item)">设置</div>
        </div>
            ...
            <div v-if="stepActive === 1" class="purchases-deploy-step1">
              <div class="step-item-block">
                <el-form-item
                  ...
                  prop="codeTxt"
                >
                  <el-input v-model="form.codeTxt"></el-input>
                </el-form-item>
              ...
              <div class="step-item-block">
                <el-form-item label="偏差结算系数：" class="item-list">
                  <el-input
                    type="number"
                    v-model="form.deviationNum"
                  ></el-input>
                </el-form-item>
                <el-form-item label="管输费：" class="item-list">
                  <el-input
                    type="number"
                    v-model="form.pipelinePrice"
                  ></el-input>
                  <span class="custom-unit">元/方</span>
                </el-form-item>
              </div>
              ...
              <div class="step-item-block">
                <el-form-item label="初始日均值：" class="item-list">
                  <el-input
                    type="number"
                    v-model="form.averageDayNum"
                  ></el-input>
                </el-form-item>
              </div>
              <el-form-item class="step1-btn">
                <el-button type="primary" @click="step1Next1('form')"
                  >下一步</el-button
                >
              </el-form-item>
            </div>
          ...
          <el-form ref="form1" :rules="rules" :model="form">
            ...
            <div class="purchases-deploy-step2" v-if="stepActive === 2">
              ...
              <div class="step-select-list" v-show="iSShowbalanced">
                ...
                <div class="step-item-block">
                  <el-form-item label="均衡一销售价格系数：" class="item-list">
                    <el-input
                      type="number"
                      v-model="form.equilibriumGasOneNum"
                    ></el-input>
                  </el-form-item>
                  <el-form-item label="气量系数:" class="item-list">
                    <el-input
                      type="number"
                      v-model="form.equilibriumGasPeakShaving"
                    ></el-input>
                  </el-form-item>
                </div>
                ...
                <div class="step-item-block">
                  ...
                  <el-form-item label="" class="item-list">
                    <el-input
                      type="number"
                      v-model="form.equilibriumGasTwoPeakShaving"
                    ></el-input>
                  </el-form-item>
                </div>
              </div>
              ...
              <el-form-item class="step1-btn">
                ...
                <el-button type="primary" @click="step2Submit('form')"
                  >提交</el-button
                >
              </el-form-item>
            </div>
            ...
            <div class="purchases-deploy-step3" v-if="stepActive === 3">
              ...
              <div class="step1-btn">
                ...
                <el-button type="primary" @click="submitBtn('1')"
                  >提交</el-button
                >
              </div>
            </div>
